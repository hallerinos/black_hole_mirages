...
# from my_create_trajectory import create_trajectory
# from my_delete_scene import delete_scene
...
#cam_loc = (0,0,-9)
cam_loc = (2.3,2,1)
cam_loc = (-10,23,0)  # for the lensing
# cam_loc = (10,23,0)  # for the unstable orbit
...
for (cl, cd, mat) in zip(cone_locations, cone_directions, trajectory_materials):
    ops.mesh.primitive_cone_add(radius1=0.15, radius2=0, depth=0.6, enter_editmode=False, align='WORLD', location=cl, scale=(1, 1, 1))
