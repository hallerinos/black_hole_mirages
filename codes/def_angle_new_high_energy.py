...
ax.add_patch(circle)
circle = plt.Circle([0,0], 1, facecolor='black', alpha=0.2, edgecolor='none', zorder=-999)
ax.add_patch(circle)
ax.text(0.0125, 0.9, f"$(a)$", transform = ax.transAxes)
ax.set_xlim(-4,+4)
ax.set_ylim(-4,+4)
...
circle = plt.Circle([0,0], 1, facecolor='black', alpha=0.2, edgecolor='none', zorder=-999)
ax.add_patch(circle)
ax.text(0.0125, 0.9, f"$(b)$", transform = ax.transAxes)
ax.set_xlim(-20,+20)
ax.set_ylim(-20,+20)
ax.set_xlabel('$x/\\rho_t$')
ax.set_ylabel('$y/\\rho_t$')
...
ax.text(0.0125, 0.95, f"$(c)$", transform = ax.transAxes)
...
ax.set_xlabel('$\\rho_p/\\rho_t$')
ax.set_ylabel('$\\varphi$')
ax.text(0.0125, 0.95, f"$(d)$", transform = ax.transAxes)
plt.tight_layout()
