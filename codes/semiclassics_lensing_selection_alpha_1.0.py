...
mpl.rcParams['figure.figsize'] = (5.927,4.0/3*5.927)
...
df_sel = df[df['alpha']==1]
df_sel = df_sel[df_sel['fd']==0.15]
df_sel = df_sel.sort_values('pos01')
# print(df_sel)
# exit()
...
axs[9].set_xlabel('$x/a$')
axs[10].set_xlabel('$x/a$')
axs[11].set_xlabel('$x/a$')

plt.savefig('fig/trajectories_alpha_1.0.jpg', dpi=300, bbox_inches='tight', pad_inches=0.01)
plt.close()